...
public class ColorBarsEditor extends PixelArrayEditor<ColorBarsArray> {
	private static final long serialVersionUID = 1L;
	
	public ColorBarsEditor() {
		this(new ColorBarsArray());
	}
	
	public ColorBarsEditor(ColorBarsArray array) {
		super(array);
	...
	@Override
	public void setPixelSet(ColorBarsArray array) {
